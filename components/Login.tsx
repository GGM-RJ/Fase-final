...
const Login: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-green-200 via-green-50 to-sky-200">
      <div className="w-full max-w-md p-8 space-y-8 bg-white/75 backdrop-blur-md rounded-2xl shadow-lg">
        <div className="text-center">
          ...
          <p className="text-gray-600">Faça login para gerenciar o stock</p>
        </div>
